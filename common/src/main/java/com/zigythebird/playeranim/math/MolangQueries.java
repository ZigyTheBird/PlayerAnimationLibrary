...
public final class MolangQueries {
    ...
    protected static void setDefaultQueryValues(ObjectValue binding) {
        ...
        // MolangLoader.setDoubleQuery(binding, FRAME_ALPHA, actor -> actor.animationState().getPartialTick());
        MolangLoader.setBoolQuery(binding, HAS_CAPE, actor -> actor.getPlayer().getSkin().capeTexture() != null);
        // MolangLoader.setBoolQuery(binding, IS_FIRST_PERSON, actor -> actor.mc.options.getCameraType() == CameraType.FIRST_PERSON);
    ...
    private static void setDefaultPlayerQueryValues(ObjectValue binding) {
        // MolangLoader.setDoubleQuery(binding, BODY_X_ROTATION, actor -> actor.getPlayer().getViewXRot(actor.animationState.getPartialTick()));
        // MolangLoader.setDoubleQuery(binding, BODY_Y_ROTATION, actor -> actor.getPlayer() instanceof LivingEntity living ? Mth.lerp(actor.animationState.getPartialTick(), living.yBodyRotO, living.yBodyRot) : actor.getPlayer().getViewYRot(actor.animationState.getPartialTick()));
        ...
        // MolangLoader.setDoubleQuery(binding, DISTANCE_FROM_CAMERA, actor -> actor.mc.gameRenderer.getMainCamera().getPosition().distanceTo(actor.getPlayer().position()));
        ...
        // MolangLoader.setBoolQuery(binding, IS_MOVING, actor -> actor.animationState.isMoving());
        ...
        // MolangLoader.setDoubleQuery(binding, MOVEMENT_DIRECTION, actor -> actor.animationState.isMoving() ? Direction.getApproximateNearest(actor.getPlayer().getDeltaMovement()).get3DDataValue() : 6);
        // MolangLoader.setDoubleQuery(binding, RIDER_BODY_X_ROTATION, actor -> actor.getPlayer().isVehicle() ? actor.getPlayer().getFirstPassenger() instanceof LivingEntity ? 0 : actor.getPlayer().getFirstPassenger().getViewXRot(actor.animationState.getPartialTick()) : 0);
        // MolangLoader.setDoubleQuery(binding, RIDER_BODY_Y_ROTATION, actor -> actor.getPlayer().isVehicle() ? actor.getPlayer().getFirstPassenger() instanceof LivingEntity living ? Mth.lerp(actor.animationState.getPartialTick(), living.yBodyRotO, living.yBodyRot) : actor.getPlayer().getFirstPassenger().getViewYRot(actor.animationState.getPartialTick()) : 0);
        // MolangLoader.setDoubleQuery(binding, RIDER_HEAD_X_ROTATION, actor -> actor.getPlayer().getFirstPassenger() instanceof LivingEntity living ? living.getViewXRot(actor.animationState.getPartialTick()) : 0);
        // MolangLoader.setDoubleQuery(binding, RIDER_HEAD_Y_ROTATION, actor -> actor.getPlayer().getFirstPassenger() instanceof LivingEntity living ? living.getViewYRot(actor.animationState.getPartialTick()) : 0);
        ...
        // MolangLoader.setDoubleQuery(binding, DEATH_TICKS, actor -> actor.getPlayer().deathTime == 0 ? 0 : actor.getPlayer().deathTime + actor.animationState.getPartialTick());
        ...
        // MolangLoader.setDoubleQuery(binding, HEAD_X_ROTATION, actor -> actor.getPlayer().getViewXRot(actor.animationState.getPartialTick()));
        // MolangLoader.setDoubleQuery(binding, HEAD_Y_ROTATION, actor -> actor.getPlayer().getViewYRot(actor.animationState.getPartialTick()));
        MolangLoader.setDoubleQuery(binding, HEALTH, actor -> actor.getPlayer().getHealth());
        // MolangLoader.setDoubleQuery(binding, HURT_TIME, actor -> actor.getPlayer().hurtTime == 0 ? 0 : actor.getPlayer().hurtTime - actor.animationState.getPartialTick());
        // MolangLoader.setDoubleQuery(binding, INVULNERABLE_TICKS, actor -> actor.getPlayer().invulnerableTime == 0 ? 0 : actor.getPlayer().invulnerableTime - actor.animationState.getPartialTick());
        ...
        // MolangLoader.setDoubleQuery(binding, MAIN_HAND_ITEM_USE_DURATION, actor -> actor.getPlayer().getUsedItemHand() == InteractionHand.MAIN_HAND ? actor.getPlayer().getTicksUsingItem() / 20d + actor.animationState.getPartialTick() : 0);
