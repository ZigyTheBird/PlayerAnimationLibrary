...
import com.zigythebird.mcanimcore.animation.keyframe.BoneAnimation;
import com.zigythebird.mcanimcore.animation.keyframe.KeyframeStack;
import com.zigythebird.mcanimcore.enums.Axis;
...
public class AnimBone {
	...
	public AnimBone add(AnimBone bone) {
	...
	public AnimBone applyOtherBone(AnimBone bone) {
		this.positionX += bone.positionX;
		this.positionY += bone.positionY;
		this.positionZ += bone.positionZ;
	...
	public AnimBone addPos(float value) {
		return addPos(value, value, value);
	}

	public AnimBone mulPos(float value) {
		return mulPos(value, value, value);
	}

	public AnimBone divPos(float value) {
		return divPos(value, value, value);
	}

	public AnimBone addRot(float value) {
		return addRot(value, value, value);
	}

	public AnimBone mulRot(float value) {
		return mulRot(value, value, value);
	}

	public AnimBone divRot(float value) {
		return divRot(value, value, value);
	}

	public AnimBone addScale(float value) {
		return addScale(value, value, value);
	}

	public AnimBone mulScale(float value) {
		return mulScale(value, value, value);
	}

	public AnimBone divScale(float value) {
		return divScale(value, value, value);
	}

	public AnimBone addPos(float x, float y, float z) {
		this.positionX += x;
		this.positionY += x;
		this.positionZ += x;
	...
	public AnimBone addRot(float x, float y, float z) {
		this.rotX += x;
		this.rotY += y;
		this.rotZ += z;
	...
	public AnimBone addScale(float x, float y, float z) {
		this.scaleX += x;
		this.scaleY += y;
		this.scaleZ += z;
	...
	public AnimBone mulPos(float x, float y, float z) {
		this.positionX *= x;
		this.positionY *= y;
		this.positionZ *= z;
		return this;
	...
	public AnimBone mulRot(float x, float y, float z) {
		this.rotX *= x;
		this.rotY *= y;
		this.rotZ *= z;
		return this;
	...
	public AnimBone mulScale(float x, float y, float z) {
		this.scaleX *= x;
		this.scaleY *= y;
		this.scaleZ *= z;
		return this;
	...
	public AnimBone divPos(float x, float y, float z) {
		this.positionX /= x;
		this.positionY /= y;
		this.positionZ /= z;
		return this;
	...
	public AnimBone divRot(float x, float y, float z) {
		this.rotX /= x;
		this.rotY /= y;
		this.rotZ /= z;
		return this;
	...
	public AnimBone divScale(float x, float y, float z) {
		this.scaleX /= x;
		this.scaleY /= y;
		this.scaleZ /= z;
		return this;
	...
	public AnimBone copyOtherBone(AnimBone bone) {
		this.positionX = bone.positionX;
		this.positionY = bone.positionY;
		this.positionZ = bone.positionZ;
	...
	public AnimBone copyOtherBoneIfNotDisabled(AnimBone bone) {
	...
	@ApiStatus.Internal
	public AnimBone beginOrEndTickLerp(AdvancedAnimBone bone, float animTime, Animation animation) {
	...
	public AnimBone copySnapshotSafe(AdvancedBoneSnapshot snapshot) {
