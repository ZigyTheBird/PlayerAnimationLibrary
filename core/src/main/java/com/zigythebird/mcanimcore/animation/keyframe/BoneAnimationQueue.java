package com.zigythebird.mcanimcore.animation.keyframe;
 ...
 */
public record BoneAnimationQueue(AnimBone bone, AnimationPointQueue rotationXQueue, AnimationPointQueue rotationYQueue,
	...
	public BoneAnimationQueue(AnimBone bone) {
