...
import com.zigythebird.mcanimcore.math.MathHelper;
...
import static com.zigythebird.mcanimcore.loading.UniversalAnimLoader.NO_KEYFRAMES;
    ...
    private Map<String, BoneAnimation> moveDeserializer(List<JsonElement> node, boolean degrees, int version) {
        ...
        for (JsonElement n : node) {
            ...
            for (Map.Entry<String, JsonElement> entry : obj.entrySet()){
                ...
                String boneKey = UniversalAnimLoader.getSnakeCaseBoneName(entry.getKey());
                if (version < 3 && boneKey.equals("torso")) boneKey = "body";// rename part

                BoneAnimation bone = bones.computeIfAbsent(UniversalAnimLoader.getSnakeCaseBoneName(boneKey), boneName ->
